                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <form class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <label class="btn btn-success control-label" id="upload" for="ar_cv_image">選擇傳記照片</label>
                                                    <em style="display: block">上傳尺寸1920*1080(2mb)</em>
                                                ...
                                                <div class="col-md-10">
                                                    <div role="tabpanel">
                                                        ...
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            ...
                                                            <li role="presentation"><a href="#cn" aria-controls="cn" role="tab" data-toggle="tab">簡中資料</a></li>
                                                            <li role="presentation"><a href="#en" aria-controls="en" role="tab" data-toggle="tab">英文資料</a></li>
                                                            <li role="presentation"><a href="#jp" aria-controls="jp" role="tab" data-toggle="tab">日文資料</a></li>
                                                        </ul>
                                                        ...
                                                        <div class="tab-content">
                                                            <div role="tabpanel" class="tab-pane active" id="tw">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-1">
                                                                        <label class="control-label"><b>傳記</b></label>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <textarea name="ar_tw_content" class="form-control" cols="30" rows="10" required placeholder="輸入傳記"><?php echo (array_key_exists('ar_tw_content', $result))?$result['ar_tw_content']:'';?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div role="tabpanel" class="tab-pane" id="cn">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <input type="text" name="ar_cn_name" class="form-control" placeholder="輸入名字" value="<?php echo (array_key_exists('ar_cn_name', $result))?$result['ar_cn_name']:'';?>">
                                                                    </div>
                                                                </div>
                                                                <br/>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <textarea name="ar_cn_content" class="form-control" cols="30" rows="10" required placeholder="輸入傳記"><?php echo (array_key_exists('ar_cn_content', $result))?$result['ar_cn_content']:'';?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div role="tabpanel" class="tab-pane" id="en">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <textarea name="ar_en_content" class="form-control" cols="30" rows="10" required placeholder="輸入傳記"><?php echo (array_key_exists('ar_en_content', $result))?$result['ar_en_content']:'';?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div role="tabpanel" class="tab-pane" id="jp">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <input type="text" name="ar_jp_name" class="form-control" placeholder="輸入名字" value="<?php echo (array_key_exists('ar_jp_name', $result))?$result['ar_jp_name']:'';?>">
                                                                    </div>
                                                                </div>
                                                                <br/>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <textarea name="ar_jp_content" class="form-control" cols="30" rows="10" required placeholder="輸入傳記"><?php echo (array_key_exists('ar_jp_content', $result))?$result['ar_jp_content']:'';?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
