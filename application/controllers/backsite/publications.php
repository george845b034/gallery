...
class Publications extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model(array('main_model', 'admin_model', 'publications_model'));
	...
	public function index()
	{
		switch ($this->input->post('type')) {
			//刪除
			case 1:
				echo json_encode($this->publications_model->deleteData($this->input->post('id')));
				break;
			default:
				$this->view();
				break;
	...
	private function view()
	{
		...
		$data['result'] = $this->publications_model->getData($this->displayCount, $currentPaage);
		...
		$this->load->view('backsite/publications', $data);
